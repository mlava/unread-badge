...
If you're using Roam Studio with Feather Icon Theme, only the following icon names are mapped and will render (others may show as a blank square): add, add-column-right, align-center, align-justify, align-left, align-right, application, bold, calculator, calendar, chat, chevron-down, chevron-left, chevron-right, chevron-up, circle-arrow-right, clean, clipboard, cloud-download, cloud-upload, code-block, cog, cross, data-lineage, database, delete, direction-left, direction-right, document, document-share, draw, duplicate, edit, exchange, export, eye-off, eye-open, fast-backward, fast-forward, filter, filter-keep, filter-list, filter-remove, flash, folder-new, fork, function, git-new-branch, graph, help, highlight, horizontal-distribution, import, info-sign, inheritance, issue-new, italic, learning, link, list, lock, manual, maximize, menu, menu-closed, menu-open, minus, moon, more, new-grid-item, new-layers, new-link, numerical, paragraph, person, pin, plus, properties, refresh, reset, search, shield, shop, sort, stacked-chart, star, star-empty, stopwatch, tag, th, tick, time, timeline-events, trash, translate, vertical-distribution, video, zoom-in.
